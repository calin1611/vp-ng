var visitsFromCurrentMonth = {};
var visitsFromCurrentWeek = {};

(function() {
    function getVisitsFromCurrentMonth() {
        $('#spinner').show();
        $.ajax({
            url: "http://localhost:59557/api/Visits/CurrentMonth",
            type: "get",
    ...
    function getVisitsFromCurrentWeek() {
        $('#spinner').show();
        $.ajax({
            url: "http://localhost:59557/api/Visits/CurrentWeek",
            type: "get",
            success: function (data) {
                visitsFromCurrentMonth = data;
                bindData(data);
    ...
    function getAgendaItemsForVisit(visit) {
        $.ajax({
            url: "http://localhost:59557/api/AgendaItems/GetAgendaItemsForVisit/" + visit.id,
            method: 'get',
            success: function (data) {
    ...
    function addVisit() {
        $.ajax({
            url: 'http://localhost:59557/api/employees/getall',
            type: 'get',
            success: function (data) {
                console.log(data);
                for (var i = 0; i < data.length; i++) {
        ...
        $('#submit-visit2').on('click', function (e) {
            ...
            $.ajax({
                url: 'http://localhost:59557/api/visits/add',
                type: 'POST',
